...
const plans = [
  {
    ...
    subtitle: "Você envia o arquivo pronto",
    description: "ISBN Digital, Ficha Catalográfica, Capa, QR Code e Conselho Editorial.",
    price: "R$ 249,90",
  ...
  },
  {
    ...
    description: "Diagramação, ISBN Digital, Ficha Catalográfica, Capa, QR Code e Conselho Editorial.",
    price: "a partir de R$ 269,90",
    priceNote: "Até 60 pág.",
    href: "/publicar/ebook",
  },
  {
    icon: Layers,
    ...
    description: "Arquivo para Impressão, ISBN Físico, Capa, Ficha Catalográfica, QR Code e Conselho Editorial.",
  ...
  },
  {
    ...
    subtitle: "E-book + Impressão",
    description: "Diagramação, E-book, Arquivo para Impressão, ISBN Digital e Físico, Capa e mais.",
  ...
  },
  {
    ...
    description: "Revisão, Diagramação, E-book, Impressão, Kindle, ISBN Digital e Físico e mais.",
    price: "a partir de R$ 559,90",
    priceNote: "Até 60 pág.",
    href: "/publicar/plus",
  },
  {
    ...
    subtitle: "Até 30 pág. | 10 autores",
    description: "Publique seu capítulo com DOI, certificado e carta de aceite.",
    price: "R$ 149,00",
    priceNote: "7 dias | R$ 190,00 urgência",
...
const services = [
  ...
  { icon: CircleCheck, label: "Revisão Ortográfica", price: "+R$ 230,00" },
