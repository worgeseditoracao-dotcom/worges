...
import { ArrowLeft, ArrowRight, BookMarked, CircleCheck } from "lucide-react";

const faixas = [
  { label: "Até 60 páginas", price: 329.90 },
  { label: "Até 150 páginas", price: 349.90 },
  { label: "300 páginas ou mais", price: 389.90 },
];
    ...
    <div className="min-h-screen bg-[var(--color-bg-subtle)]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold">Pacote Completo</h1>
            <p className="text-sm text-[var(--color-text-muted)]">E-book + Arquivo para Impressão</p>
          </div>
        </div>
        ...
        <div className="gradient-card rounded-[var(--radius-xl)] border border-[var(--color-border)] p-6 sm:p-8">
          ...
          <Link
            href="/publicar/completo/submeter"
